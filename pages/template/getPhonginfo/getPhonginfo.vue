		...
		<view class="page-body">
			<view class="page-section">
				<view class="uni-list">
					...
					<view class="uni-list-cell">
						<view class="uni-pd">
							<view class="uni-label">引擎版本号</view>
						</view>
						<view class="uni-list-cell-db">
					...
					<view class="uni-list-cell">
						<view class="uni-pd">
							<view class="uni-label">操作系统版本</view>
						</view>
						<view class="uni-list-cell-db">
					...
					<view class="uni-list-cell">
						<view class="uni-pd">
							<view class="uni-label">客户端平台</view>
						</view>
						<view class="uni-list-cell-db">
					...
					<view class="uni-list-cell">
						<view class="uni-pd">
							<view class="uni-label">可使用窗口宽度</view>
						</view>
						<view class="uni-list-cell-db">
					...
					<view class="uni-list-cell">
						<view class="uni-pd">
							<view class="uni-label">可使用窗口高度</view>
						</view>
						<view class="uni-list-cell-db">
					...
					<view class="uni-list-cell">
						<view class="uni-pd">
							<view class="uni-label">状态栏的高度</view>
						</view>
						<view class="uni-list-cell-db">
					...
					<view class="uni-list-cell">
						<view class="uni-pd">
							<view class="uni-label">设备像素比（DPI）</view>
						</view>
						<view class="uni-list-cell-db">
